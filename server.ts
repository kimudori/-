...
// The following updates were overwriting user data on every restart. 
// They should only run if the data is missing or we are in a fresh state.
// For now, we rely on the initialContent INSERT OR IGNORE above.
